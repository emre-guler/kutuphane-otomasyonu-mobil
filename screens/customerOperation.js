...
export default class customerOperation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoaded: false,
      tableHead: ['Id', 'Fullname', 'TC ID', 'Operation'],
      tableData: []
    }
  ...
  deleteIndex = async (index) => {
    const response = await fetch('https://0b61ec72.ngrok.io/api/library/customeroperation',{
      ...
      body: JSON.stringify({
        ...
        'deletecustomerid': this.state.tableData[index][0]
      })
    })
      ...
      return (
        <ScrollView style={styles.container}>
          <View style={styles.bigTitleContainer}>
              <Text style={styles.bigTitle}>Customer Operaiton</Text>
          </View>
          ...
          <View style={styles.buttonContainer}>
              <TouchableOpacity style={styles.button} onPress={() => navigate('addcustomer')}>
